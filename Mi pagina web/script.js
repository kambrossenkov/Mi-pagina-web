...
const translations = {
  en: {
    ...
    "hero-desc": "I'm Konstantino Ambrossenkov — ITBA graduate, working in data and operations. Explore my journey and projects here.",
    "hero-btn": "Contact Me",
...
function renderArticles() {
  ...
  featuredArticles.forEach((article, index) => {
    ...
    const imageSection = isCV
      ? `<div style="width:100%;height:100%;background:linear-gradient(135deg,#0a1628 0%,#0f2340 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;"><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg><span style="font-size:11px;font-weight:700;letter-spacing:2px;color:#93c5fd;">CV</span></div>`
